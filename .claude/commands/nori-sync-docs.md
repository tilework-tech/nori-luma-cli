...
allowed-tools: Bash(node /home/amol/code/nori/nori-luma-cli/.worktrees/mild-log-20260608-224550/.claude/skills/nori-sync-docs/script.js:*)
---
...
```bash
node /home/amol/code/nori/nori-luma-cli/.worktrees/mild-log-20260608-224550/.claude/skills/nori-sync-docs/script.js
```
